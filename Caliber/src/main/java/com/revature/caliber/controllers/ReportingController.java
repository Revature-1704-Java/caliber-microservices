...
public class ReportingController {
	 ...
	 *******************************************************
	 */
	@RequestMapping(value = "http://localhost:8081/reporting/all/reports/batch/week/stacked-bar-current-week", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
